...
# list 2 has been created by iterating list 1
...
print("".join(list11)) #combining the chars in list11 together as a string
print("-".join(list11)) #adding a dash between characters
